...
//***************************** Is Display Methods **********************************************//
    ...
    public boolean verifyIfExpectedTextIsDisplayed(String actualText, String expectedText) {
    ...
    public void switchToIframe(WebElement element){driver.switchTo().frame(element);}

    public void acceptIframeCookies(){
